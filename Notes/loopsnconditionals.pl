...
#Conditional:If, if else, if elseif else, unless
...
#For loop
#for (intial value; condition you want to meet; increment){}
...
$num1 = 230;
for ($i = 1; $i <= 5; $i++){
    #Add 230 and 360, add 230 to the result
    $num1 += 360;
    print("Result: $num1\n");    
...
#When checkinng numeric values, use ==. WHen checking strings (words) use eq
...
if ($response eq "yes"){
    ...
    print("You chose no\n");
      ...
      print("you didnt pick yes no or maybe\n");
}
